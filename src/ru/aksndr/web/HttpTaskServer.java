...
public class HttpTaskServer {
    ...
    public void start() throws IOException {
        ...
        server.createContext("/tasks", new WorkItemHandler(manager));
        server.createContext("/epics", new WorkItemHandler(manager));
        server.createContext("/subtasks", new WorkItemHandler(manager));
